 ...
 * @date 1/5/21
 */
public class SonarScannerDockerGenerator implements DockerGenerator {

    private static final Logger logger = LoggerFactory.getLogger(SonarScannerDockerGenerator.class);
    @Override
    public String generate(List<String> runCommand, Map<String, String> properties, SonarProperties sonarProperties) {

        logger.info("SonarScannerDockerGenerator");
